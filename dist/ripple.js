...
var _rijs25 = require('rijs.redis');

var _rijs26 = _interopRequireDefault(_rijs25);

var _rijs27 = require('rijs.needs');
...
var _rijs35 = require('rijs.css');

var _rijs36 = _interopRequireDefault(_rijs35);

var _rijs37 = require('rijs.fn');
...
function create(opts) {
  ...
  (0, _rijs36.default)(ripple); // register css types
  (0, _rijs38.default)(ripple); // register fn types
  (0, _rijs16.default)(ripple); // expose helper functions and constants
  (0, _rijs26.default)(ripple, opts); // add redis cache
  (0, _rijs4.default)(ripple); // invoke web components, fn.call(<el>, data)
  (0, _rijs28.default)(ripple); // define default attrs for components
...
},{"rijs.backpressure":38,"rijs.components":39,"rijs.core":42,"rijs.css":44,"rijs.data":45,"rijs.features":46,"rijs.fn":47,"rijs.helpers":48,"rijs.needs":49,"rijs.offline":50,"rijs.pages":8,"rijs.precss":51,"rijs.redis":8,"rijs.resdir":8,"rijs.serve":8,"rijs.sessions":8,"rijs.singleton":52,"rijs.sync":53,"rijs.versioned":54,"utilise":105}],2:[function(require,module,exports){
...
},{"./polling":20,"component-emitter":23,"component-inherit":11,"debug":24,"xmlhttprequest-ssl":22}],20:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":11,"debug":24,"engine.io-parser":26,"parseqs":35,"xmlhttprequest-ssl":22,"yeast":149}],21:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":11,"debug":24,"engine.io-parser":26,"parseqs":35,"ws":7,"yeast":149}],22:[function(require,module,exports){
(function (global){
...
},{"./keys":27,"after":2,"arraybuffer.slice":3,"base64-arraybuffer":5,"blob":6,"has-binary":28,"wtf-8":148}],27:[function(require,module,exports){
...
},{"utilise/all":70,"utilise/attr":73,"utilise/by":75,"utilise/err":88,"utilise/flatten":93,"utilise/from":96,"utilise/group":98,"utilise/identity":102,"utilise/includes":104,"utilise/is":106,"utilise/key":108,"utilise/lo":111,"utilise/log":112,"utilise/noop":114,"utilise/not":115,"utilise/ready":129,"utilise/split":135,"utilise/unique":142,"utilise/values":144}],39:[function(require,module,exports){
'use strict';
...
},{"./types/data":40,"./types/fn":41,"utilise/all":70,"utilise/attr":73,"utilise/err":88,"utilise/header":101,"utilise/includes":104,"utilise/is":106,"utilise/key":108,"utilise/lo":111,"utilise/log":112,"utilise/noop":114,"utilise/overwrite":118,"utilise/proxy":126,"utilise/time":140,"utilise/values":144}],40:[function(require,module,exports){
'use strict';
...
},{"utilise/all":70}],41:[function(require,module,exports){
'use strict';
...
},{"utilise/all":70,"utilise/includes":104}],42:[function(require,module,exports){
'use strict';
...
},{"./types/text":43,"utilise/colorfill":78,"utilise/emitterify":87,"utilise/err":88,"utilise/header":101,"utilise/identity":102,"utilise/is":106,"utilise/key":108,"utilise/log":112,"utilise/to":141,"utilise/values":144,"utilise/za":147}],43:[function(require,module,exports){
'use strict';
...
},{"utilise/includes":104,"utilise/is":106}],44:[function(require,module,exports){
'use strict';
...
},{"utilise/includes":104,"utilise/log":112}],45:[function(require,module,exports){
'use strict';
...
},{"utilise/extend":90,"utilise/header":101,"utilise/is":106,"utilise/key":108,"utilise/log":112,"utilise/not":115,"utilise/overwrite":118,"utilise/set":132}],46:[function(require,module,exports){
'use strict';
...
},{"utilise/append":71,"utilise/attr":73,"utilise/by":75,"utilise/from":96,"utilise/header":101,"utilise/includes":104,"utilise/is":106,"utilise/key":108,"utilise/log":112,"utilise/not":115,"utilise/str":136}],47:[function(require,module,exports){
'use strict';
...
},{"utilise/fn":94,"utilise/is":106,"utilise/log":112,"utilise/str":136}],48:[function(require,module,exports){
'use strict';
...
},{"utilise/by":75,"utilise/def":83,"utilise/fn":94,"utilise/identity":102,"utilise/is":106,"utilise/keys":109,"utilise/log":112,"utilise/str":136,"utilise/values":144}],49:[function(require,module,exports){
'use strict';
...
},{"utilise/attr":73,"utilise/err":88,"utilise/includes":104,"utilise/key":108,"utilise/lo":111,"utilise/log":112,"utilise/replace":131,"utilise/split":135}],50:[function(require,module,exports){
'use strict';
...
// -------------------------------------------
// API: Cache to and Restore from localStorage and IndexedDB
// -------------------------------------------
function offline(ripple) {
  if (!true || !window.indexedDB) return;
  log('creating IndexedDB');
  init1(ripple); // indexeddb

  if (!true || !window.localStorage) return;
  log('creating localstorage');
  init2(ripple); //localstorage

  return ripple;
}

var init1 = function init1(ripple) {
  var dbName = 'ripple_2',
      con = window.indexedDB.open(dbName);

  con.onupgradeneeded = schema;
  con.onsuccess = load;
  ripple.on('change.cache-idb', (0, _debounce2.default)(1000)(cache));

  function schema(e) {
    var db = e.target.result;
    (0, _values2.default)(ripple.resources).filter((0, _not2.default)((0, _header2.default)('cache', 'no-store'))).filter((0, _header2.default)('content-type', 'application/data')).map(function (r) {
      return db.createObjectStore(r.name, (0, _header2.default)('indexedDB')(r));
    });
  }
  ...
  function load(e) {
    return (0, _group2.default)('loading cache', function (d) {
      var db = e.target.result,
          stores = [].concat(_toConsumableArray(db.objectStoreNames));
      stores.map(function (k) {
        return [k, db.transaction(k, "readonly")];
      }).map(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
            k = _ref2[0],
            tx = _ref2[1];

        return [k, tx.objectStore(k)];
      }).map(function (_ref3) {
        var _ref4 = _slicedToArray(_ref3, 2),
            k = _ref4[0],
            s = _ref4[1];
        ...
        return v.onsuccess = function (e) {
          return ripple(k, e.target.result);
        };
      });
      db.close();
    });
  ...
  function cache(name, _ref7) {
    var type = _ref7.type,
        value = _ref7.value,
        time = _ref7.time;

    if ((0, _values2.default)(ripple.resources).filter((0, _not2.default)((0, _header2.default)('cache', 'no-store'))).filter((0, _header2.default)('content-type', 'application/data')).map(function (r) {
      return r.name;
    }).indexOf(name) > -1) {
      //when time is 0 need to upgrade schema 
      var _con = window.indexedDB.open(dbName);
      _con.onblocked = function (e) {
        log(e);
      };
      _con.onfailure = function (e) {
        log(e);
      };
      _con.onsuccess = function (e) {
        var version = con.result.version,
            upgrade = time == 0 ? version + 1 : version,
            con = window.indexedDB.open(dbName, upgrade);
        scheme(ripple)(con);
...
var init2 = function init2(ripple) {
  load(ripple);
  ripple.on('change.cache-ls', (0, _debounce2.default)(1000)(cache));
  ...
  function cache(name, _ref8) {
    var type = _ref8.type,
        value = _ref8.value,
        time = _ref8.time;

    log('cached');
    var cachable = (0, _values2.default)((0, _clone2.default)(ripple.resources)).filter((0, _not2.default)((0, _header2.default)('cache', 'no-store'))).filter((0, _not2.default)((0, _header2.default)('content-type', 'application/data')));

    cachable.filter((0, _header2.default)('content-type', 'application/javascript')).filter((0, _not2.default)((0, _header2.default)('content-type', 'application/data'))).map(function (d) {
...
},{"utilise/clone":77,"utilise/debounce":82,"utilise/err":88,"utilise/first":92,"utilise/group":98,"utilise/header":101,"utilise/log":112,"utilise/not":115,"utilise/parse":120,"utilise/promise":125,"utilise/str":136,"utilise/values":144}],51:[function(require,module,exports){
'use strict';
...
},{"cssscope":12,"utilise/all":70,"utilise/attr":73,"utilise/by":75,"utilise/el":86,"utilise/err":88,"utilise/from":96,"utilise/identity":102,"utilise/is":106,"utilise/log":112,"utilise/not":115,"utilise/proxy":126,"utilise/raw":128,"utilise/str":136,"utilise/values":144}],52:[function(require,module,exports){
'use strict';
...
},{"utilise/log":112,"utilise/owner":119}],53:[function(require,module,exports){
'use strict';
...
},{"express":8,"socket.io":8,"socket.io-client":55,"utilise/by":75,"utilise/clone":77,"utilise/deb":81,"utilise/def":83,"utilise/err":88,"utilise/extend":90,"utilise/header":101,"utilise/identity":102,"utilise/is":106,"utilise/key":108,"utilise/keys":109,"utilise/log":112,"utilise/noop":114,"utilise/not":115,"utilise/promise":125,"utilise/set":132,"utilise/str":136,"utilise/to":141,"utilise/values":144}],54:[function(require,module,exports){
'use strict';
...
},{"utilise/by":75,"utilise/clone":77,"utilise/def":83,"utilise/err":88,"utilise/is":106,"utilise/key":108,"utilise/log":112,"utilise/set":132,"utilise/values":144}],55:[function(require,module,exports){
...
},{"./on":57,"./socket":58,"backo2":4,"component-bind":9,"component-emitter":60,"debug":61,"engine.io-client":13,"indexof":30,"socket.io-parser":64}],57:[function(require,module,exports){
...
},{"./on":57,"component-bind":9,"component-emitter":60,"debug":61,"has-binary":28,"socket.io-parser":64,"to-array":69}],59:[function(require,module,exports){
(function (global){
...
},{"./debug":62,"_process":37,"dup":24}],62:[function(require,module,exports){
arguments[4][25][0].apply(exports,arguments)
},{"dup":25,"ms":33}],63:[function(require,module,exports){
(function (global){
/*global Blob,File*/
...
},{"./is-buffer":65,"isarray":31}],64:[function(require,module,exports){
...
},{"./to":141}],71:[function(require,module,exports){
...
},{"./is":106,"./to":141}],73:[function(require,module,exports){
var is = require('./is')
...
},{"./is":106}],74:[function(require,module,exports){
var key = require('./key')
...
},{"./key":108}],75:[function(require,module,exports){
var key = require('./key')
  , is  = require('./is')
...
},{"./is":106,"./key":108}],76:[function(require,module,exports){
...
},{"./is":106,"./parse":120,"./str":136}],78:[function(require,module,exports){
...
},{"./client":76,"./has":99,"./is":106,"colors":8}],79:[function(require,module,exports){
...
},{"./client":76,"./identity":102,"./is":106,"./key":108,"./owner":119,"./split":135,"./to":141}],82:[function(require,module,exports){
var is = require('./is')
...
},{"./is":106}],83:[function(require,module,exports){
var has = require('./has')
...
},{"./has":99}],84:[function(require,module,exports){
var keys = require('./keys')
  , is = require('./is')
...
},{"./is":106,"./keys":109}],85:[function(require,module,exports){
...
},{"./attr":73,"./prepend":124,"./replace":131,"./split":135}],87:[function(require,module,exports){
...
},{"./def":83,"./err":88,"./is":106,"./keys":109,"./not":115}],88:[function(require,module,exports){
var is = require('./is')
  , to = require('./to')
  , owner = require('./owner')
...
},{"./is":106,"./owner":119,"./to":141}],89:[function(require,module,exports){
...
},{"./copy":79,"./is":106,"./keys":109,"./not":115}],91:[function(require,module,exports){
...
},{"./is":106}],94:[function(require,module,exports){
var is = require('./is')
...
},{"./is":106}],95:[function(require,module,exports){
...
},{"./all":70,"./attr":73,"./includes":104}],96:[function(require,module,exports){
...
},{"./datum":80,"./key":108}],97:[function(require,module,exports){
var to = require('./to')
  , is = require('./is')
...
},{"./is":106,"./to":141}],98:[function(require,module,exports){
var client = require('./client')
  , owner = require('./owner')
  , noop = require('./noop')
...
},{"./client":76,"./noop":114,"./owner":119}],99:[function(require,module,exports){
...
},{"./key":108}],102:[function(require,module,exports){
...
},{"./all":70,"./append":71,"./args":72,"./attr":73,"./az":74,"./by":75,"./client":76,"./clone":77,"./colorfill":78,"./copy":79,"./datum":80,"./deb":81,"./debounce":82,"./def":83,"./defaults":84,"./done":85,"./el":86,"./emitterify":87,"./err":88,"./escape":89,"./extend":90,"./falsy":91,"./file":7,"./first":92,"./flatten":93,"./fn":94,"./form":95,"./from":96,"./grep":97,"./group":98,"./has":99,"./hashcode":100,"./header":101,"./identity":102,"./iff":103,"./includes":104,"./is":106,"./join":107,"./key":108,"./keys":109,"./last":110,"./lo":111,"./log":112,"./mo":113,"./noop":114,"./not":115,"./nullify":116,"./once":117,"./overwrite":118,"./owner":119,"./parse":120,"./patch":121,"./pause":7,"./perf":122,"./pop":123,"./prepend":124,"./promise":125,"./proxy":126,"./push":127,"./raw":128,"./ready":129,"./remove":130,"./replace":131,"./send":7,"./set":132,"./slice":133,"./sort":134,"./split":135,"./str":136,"./stripws":137,"./tdraw":138,"./th":139,"./time":140,"./to":141,"./unique":142,"./update":143,"./values":144,"./via":7,"./wait":145,"./wrap":146,"./za":147}],106:[function(require,module,exports){
module.exports = is
is.fn      = isFunction
is.str     = isString
is.num     = isNumber
...
},{"./by":75,"./clone":77,"./is":106,"./key":108}],108:[function(require,module,exports){
var str = require('./str')
  , is = require('./is')
...
},{"./is":106,"./str":136}],109:[function(require,module,exports){
var is = require('./is')

module.exports = function keys(o) { 
  return Object.keys(is.obj(o) || is.fn(o) ? o : {})
}
},{"./is":106}],110:[function(require,module,exports){
...
},{"./is":106,"./owner":119,"./to":141}],113:[function(require,module,exports){
...
},{"./owner":119}],114:[function(require,module,exports){
...
},{"./is":106}],117:[function(require,module,exports){
'use strict'
...
},{"./emitterify":87,"./key":108,"./keys":109}],118:[function(require,module,exports){
var is = require('./is')
  , keys = require('./keys')
  , copy = require('./copy')
...
},{"./copy":79,"./is":106,"./keys":109}],119:[function(require,module,exports){
(function (global){
var client = require('./client')
module.exports = client ? /* istanbul ignore next */ window : global
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./client":76}],120:[function(require,module,exports){
...
},{"./keys":109,"./set":132}],122:[function(require,module,exports){
(function (process){
...
},{"./client":76,"./log":112,"_process":37}],123:[function(require,module,exports){
...
},{"./is":106,"./last":110,"./set":132}],124:[function(require,module,exports){
...
},{"./identity":102,"./is":106}],127:[function(require,module,exports){
var set = require('./set')
  , is = require('./is')
...
},{"./is":106,"./set":132}],128:[function(require,module,exports){
...
},{"./key":108,"./set":132}],131:[function(require,module,exports){
...
},{"./def":83,"./emitterify":87,"./is":106}],133:[function(require,module,exports){
...
},{"./is":106}],137:[function(require,module,exports){
var is = require('./is')
...
},{"./is":106}],138:[function(require,module,exports){
...
},{"./is":106}],142:[function(require,module,exports){
var is = require('./is')
...
},{"./is":106}],143:[function(require,module,exports){
var set = require('./set')
...
},{"./set":132}],144:[function(require,module,exports){
var keys = require('./keys')
  , from = require('./from')
...
},{"./from":96,"./keys":109}],145:[function(require,module,exports){
...
},{"./key":108}],148:[function(require,module,exports){
(function (global){
